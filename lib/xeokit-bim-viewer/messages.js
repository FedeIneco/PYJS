...
const messages = {
    ...
    "en": {
        ...
        "selectionsSetsExplorer":{
            "title": "Sets",
            "showAll": "Show all",
            "showAllTip": "Show all Sets",
            "hideAll": "Hide all",
            "hideAllTip": "Hide all Sets"
        },
        ...
        "objectContextMenu": { // Context menu that appears when we right-click on an object in the 3D view
            ...
            "createSelection": "Create Selection",//Menu option to create a new selection        
            "showSelection": "Show Selection"//Menu option to show the selections
        },        
